...
urlpatterns = patterns('comprobantes.views',
    ...
    url(r'^bancos/bancos_eliminar/(?P<id>[\w-]+)/$', BancosDeleteView, name="bancos_eliminar"),
    ...
    url(r'^percimp/percimp_eliminar/(?P<id>[\w-]+)/$', PercImpDeleteView, name="percimp_eliminar"),
    ...
    url(r'^retenc/retenc_eliminar/(?P<id>[\w-]+)/$', RetencDeleteView, name="retenc_eliminar"),
    ...
    url(r'^disponibilidades/disponibilidades_eliminar/(?P<id>[\w-]+)/$', DispoDeleteView, name="disponibilidades_eliminar"),
