...
urlpatterns = patterns(
    ...
    url(
        r"^movimientos/movimientos_editar/(?P<id>\d+)/$",
        MovInternosEditView.as_view(),
        name="movimientos_editar",
    ),
    url(
        r"^movimientos/movimientos_eliminar/(?P<id>[\w-]+)/$",
        MovInternosDeleteView,
        name="movimientos_eliminar",
    ),
    ...
    url(
        r"^cpb_anular_reactivar/(?P<id>\d+)/(?P<estado>\d+)/$",
        cpb_anular_reactivar,
        name="cpb_anular_reactivar",
    ),
    url(r"^cpbs_anular/$", cpbs_anular, name="cpbs_anular"),
    url(
        r"^cpb_editar_seguimiento/(?P<id>\d+)/$",
        EditarSeguimientoView.as_view(),
        name="cpb_editar_seguimiento",
    ),
    ...
    url(
        r"^eliminar_detalles_fp_huerfanos/$",
        eliminar_detalles_fp_huerfanos,
        name="eliminar_detalles_fp_huerfanos",
    ),
    url(
        r"^eliminar_detalles_prods_huerfanos/$",
        eliminar_detalles_prods_huerfanos,
        name="eliminar_detalles_prods_huerfanos",
    ),
    ...
    url(
        r"^pto_vta/pto_vta_numero_cambiar/(?P<id>\d+)/(?P<nro>\d+)/$",
        pto_vta_numero_cambiar,
        name="pto_vta_numero_cambiar",
    ),
    url(r"^disponibilidades/$", DispoView.as_view(), name="disponibilidades_listado"),
    url(
        r"^disponibilidades/disponibilidades_nuevo/$",
        DispoCreateView.as_view(),
        name="disponibilidades_nuevo",
    ),
    url(
        r"^disponibilidades/disponibilidades_editar/(?P<id>\d+)/$",
        DispoEditView.as_view(),
        name="disponibilidades_editar",
    ),
    url(
        r"^disponibilidades/disponibilidades_eliminar/(?P<id>[\w-]+)/$",
        DispoDeleteView,
        name="disponibilidades_eliminar",
    ),
