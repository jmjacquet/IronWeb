...
urlpatterns = patterns('entidades.views',
    ...
    url(r'^clientes/cliente_eliminar/(?P<id>[\w-]+)/$', ClientesDeleteView, name="cliente_eliminar"),
    ...
    url(r'^proveedores/proveedor_eliminar/(?P<id>[\w-]+)/$', ProveedoresDeleteView, name="proveedor_eliminar"),
    ...
    url(r'^vendedores/vendedor_eliminar/(?P<id>[\w-]+)/$', VendedoresDeleteView, name="vendedor_eliminar"),
