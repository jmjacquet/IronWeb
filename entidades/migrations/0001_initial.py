    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_doc', models.IntegerField(default=99, null=True, verbose_name='Tipo Documento', blank=True, choices=[(80, b'CUIT'), (86, b'CUIL'), (87, b'CDI'), (89, b'LE'), (90, b'LC'), (91, b'CI Extr.'), (92, b'En tr\xc3\xa1mite'), (93, b'Acta Nac.'), (94, b'Pasaporte'), (95, b'CI'), (96, b'DNI'), (99, b'CF'), (30, b'C.Migr.'), (88, b'Usado Anses')])),
                ('nro_doc', models.CharField(max_length=50, null=True, verbose_name='Documento', blank=True)),
                ...
                ('tope_cta_cte', models.DecimalField(decimal_places=3, default=0, max_digits=15, blank=True, null=True, verbose_name='Tope CtaCte')),
                ('contacto1_nombre', models.CharField(max_length=200, null=True, verbose_name='Detalle Contacto 1', blank=True)),
                ('contacto1_email', models.EmailField(max_length=254, null=True, verbose_name='Email', blank=True)),
                ('contacto1_tel', models.CharField(max_length=50, null=True, verbose_name='Tel\xe9fono', blank=True)),
                ('contacto2_nombre', models.CharField(max_length=200, null=True, verbose_name='Detalle Contacto 2', blank=True)),
                ('contacto2_email', models.EmailField(max_length=254, null=True, verbose_name='Email', blank=True)),
                ('contacto2_tel', models.CharField(max_length=50, null=True, verbose_name='Tel\xe9fono', blank=True)),
                ('contacto3_nombre', models.CharField(max_length=200, null=True, verbose_name='Detalle Contacto 3', blank=True)),
                ('contacto3_email', models.EmailField(max_length=254, null=True, verbose_name='Email', blank=True)),
                ('contacto3_tel', models.CharField(max_length=50, null=True, verbose_name='Tel\xe9fono', blank=True)),
                ('contacto4_nombre', models.CharField(max_length=200, null=True, verbose_name='Detalle Contacto 4', blank=True)),
                ('contacto4_email', models.EmailField(max_length=254, null=True, verbose_name='Email', blank=True)),
                ('contacto4_tel', models.CharField(max_length=50, null=True, verbose_name='Tel\xe9fono', blank=True)),
                ('contacto5_nombre', models.CharField(max_length=200, null=True, verbose_name='Detalle Contacto 5', blank=True)),
                ('contacto5_email', models.EmailField(max_length=254, null=True, verbose_name='Email', blank=True)),
                ('contacto5_tel', models.CharField(max_length=50, null=True, verbose_name='Tel\xe9fono', blank=True)),
            ],
            options={
