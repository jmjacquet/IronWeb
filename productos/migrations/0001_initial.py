...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='prod_producto_stock',
            fields=[
                ('id', models.AutoField(db_index=True, serialize=False, primary_key=True)),
                ('stock', models.DecimalField(default=1, verbose_name='Stock', max_digits=5, decimal_places=2)),
            ],
            options={
                'db_table': 'prod_producto_stock',
            },
        ),
        migrations.CreateModel(
            name='prod_productos',
        ...
        migrations.AddField(
            model_name='prod_producto_stock',
            name='producto',
