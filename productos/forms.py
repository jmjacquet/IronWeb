...
class Producto_ListaPreciosForm(forms.ModelForm):
	...
	precio_itc = forms.DecimalField(label='Valor ITC',widget=PrependWidget(attrs={'class':'form-control','step':0.00},base_widget=NumberInput, data='$'),initial=vitc,decimal_places=2)
	precio_tasa = forms.DecimalField(label='Valor Tasa',widget=PrependWidget(attrs={'class':'form-control','step':0.00},base_widget=NumberInput, data='$'),initial=vtasa,decimal_places=2)	
